...
public class FinalMirror extends PApplet {
...
//    String portName = Serial.list()[5];
    String portName = "/dev/tty.usbserial-A403JV6Y";
//    println(portName);
...
// Linear brightness:        
         br2 = PApplet.parseInt(brightTot / 8);
  ...
  public void settings() {  size(850, 850, JAVA2D);  smooth(); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "FinalMirror" };
    if (passedArgs != null) {
